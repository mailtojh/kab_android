...
uf_setDeptList = function(aDepts) {
	...
	for(var i in aDepts) {
		...
		if(aDepts[i].DATA_LVL!="3") { 
			arrHtml[j++] = '<div id="lv_dept_'+(aDepts[i].DATA_LVL=="1"?aDepts[i].LVL_CD1:aDepts[i].LVL_CD2)+'" dept-level="'+aDepts[i].DATA_LVL+'" data-role="collapsible" '+(aDepts[i].DATA_LVL=="2"?' data-collapsed-icon="plus" data-expanded-icon="minus" data-theme="b" ':"")+'><h2>'+(aDepts[i].DATA_LVL=="1"?aDepts[i].LVL_NM1:aDepts[i].LVL_NM2)+'</h2>';
		}
